...
var UpdateDashboard = (function () {
	function UpdateDashboard() {
		_classCallCheck(this, UpdateDashboard);
	...
	_createClass(UpdateDashboard, [{
		key: "updateStaff",
		value: function updateStaff(data) {
		...
		key: "updateBoxState",
		value: function updateBoxState(now, previous, container) {
			if (now < previous) {
...
exports["default"] = UpdateDashboard;
